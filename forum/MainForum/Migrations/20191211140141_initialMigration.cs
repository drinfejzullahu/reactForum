    ...
    public partial class initialMigration : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Sort_Categories", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Sort_CategoryId = table.Column<long>(nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Posts_Sort_Categories_Sort_CategoryId",
                        column: x => x.Sort_CategoryId,
                        principalTable: "Sort_Categories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Subscribed_Rooms", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Subscribed_Rooms_Rooms_RoomId",
                        column: x => x.RoomId,
                        principalTable: "Rooms",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Subscribed_Rooms_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Posts_Sort_CategoryId",
                table: "Posts",
                column: "Sort_CategoryId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Subscribed_Rooms_RoomId",
                table: "Subscribed_Rooms",
                column: "RoomId");

            migrationBuilder.CreateIndex(
                name: "IX_Subscribed_Rooms_UserId",
                table: "Subscribed_Rooms",
                column: "UserId");
        }
